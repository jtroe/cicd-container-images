...
RUN powershell (New-Object System.Net.WebClient).DownloadFile(${ARCGIS_PRO_3_CAB_URL}) && \
    powershell (New-Object System.Net.WebClient).DownloadFile(${ARCGIS_PRO_3_CAB1_URL}) && \
    powershell (New-Object System.Net.WebClient).DownloadFile(${ARCGIS_PRO_3_MSI_URL}) && \
